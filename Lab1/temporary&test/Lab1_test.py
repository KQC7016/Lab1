...
firefox_bin = 'C:/Program Files/Google/Chrome/Application/chrome.exe'
edge_bin = 'C:/Program Files (x86)/Microsoft/Edge/Application/msedge.exe'
chrome_driver_bin = 'F:/Works/Python/KQC7016/KQC7016-Lab1/WebDriver/ChromeDriver/chromedriver.exe'
firefox_driver_bin = 'F:/Works/Python/KQC7016/KQC7016-Lab1/WebDriver/FirefoxDriver/geckodriver.exe'
edge_driver_bin = 'F:/Works/Python/KQC7016/KQC7016-Lab1/WebDriver/Edgedriver/msedgedriver.exe'


def simulate_browser(browser, url):
    global chrome_driver_bin, chrome_bin
    global firefox_driver_bin, firefox_bin
    global edge_driver_bin, edge_bin
...
def spider_initialization():
    ...
    browser_label = tk.Label(input_window, text="Please Choose Browser Kernel", bg='lightblue')
    ...
    url_label = tk.Label(input_window, text="Please Enter URL", bg='lightblue')
...
def main():
    ...
    # 选择浏览器内核并输入网页URL地址
    browser, url = spider_initialization()
    print("\n***Spider_Initialization***\n")
    # 如果browser为空，则将其设为默认值"Chrome"
    if not browser:
        browser = "Chrome"  # ["Chrome", "Firefox", "Edge", "Safari"]
        print("Browser Kernel: {}(default)".format(browser))
    else:
