...
def bili_index_video_details(soup, log):
...
def bilibili_parsing(soup):

    bili_channels_log = 1  # 是否频道信息
    bili_channels(soup, bili_channels_log)

    bili_index_video_log = 1  # 是否打印首页视频详细信息
    bili_index_video_details(soup, bili_index_video_log)
