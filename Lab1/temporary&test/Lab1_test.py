...
def simulate_browser(browser, url):
    ...
    # # 使用 execute_async_script 方法执行 JavaScript，等待页面加载完成
    ...
    #     print("Permanent redirect: The page has been permanently moved to a new location.")
    #     exit()
    #
    # elif response_code == 302:
    #     print("Temporary redirect: The page has temporarily moved to a new location.")
    #     exit()
    #
    # elif response_code == 400:
    #     print("Bad request: The server cannot process the request due to a client error.")
    #     exit()
    #
    ...
    #     print("Not found: The server could not find the requested page.")
    #     exit()
    #
    # elif response_code == 500:
    #     print("Internal server error: The server encountered an unexpected condition that prevented it from "
